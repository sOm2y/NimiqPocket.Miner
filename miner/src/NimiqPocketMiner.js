...
class NimiqPocketMiner extends BasePoolMiner {
    /**
    ...
    async _onBlockMined(block, fullValid) {
        ...
        if (readyState === 3) {
            Nimiq.Log.w(NimiqPocketMiner, `Incorrect websocket state detected! Reconnecting`);
...
module.exports = NimiqPocketMiner;